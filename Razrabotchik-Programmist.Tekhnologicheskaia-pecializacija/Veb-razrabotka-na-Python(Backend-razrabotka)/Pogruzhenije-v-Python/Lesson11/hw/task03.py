...
class Rectangle:
    def __init__(self, width, height=None):
        ...
        Если высота не указана, прямоугольник будет квадратом."""
        self.width = width
        self.height = height if height is not None else width  # Если height не передан, устанавливаем как width
    ...
    def __add__(self, other):
        """Метод для сложения двух прямоугольников (по периметру)."""
    ...
    def __sub__(self, other):
        """Метод для вычитания одного прямоугольника из другого (по периметру)."""
        if isinstance(other, Rectangle):
    ...
    def __lt__(self, other):
        """Метод для сравнения площади двух прямоугольников (меньше)."""
        if isinstance(other, Rectangle):
            return self.area() < other.area()
        return False

    def __eq__(self, other):
        """Метод для сравнения площади двух прямоугольников (равно)."""
        if isinstance(other, Rectangle):
            return self.area() == other.area()
        return False

    def __le__(self, other):
        """Метод для сравнения площади двух прямоугольников (меньше или равно)."""
        if isinstance(other, Rectangle):
            return self.area() <= other.area()
        return False

    def __str__(self):
        """Метод для строкового представления прямоугольника."""
        return f"Прямоугольник со сторонами {self.width} и {self.height}"

    def __repr__(self):
        """Метод для представления прямоугольника, который можно использовать для создания нового объекта."""

package animation.draw_pic.view;

import animation.circles.exceptions.BallsOverflowException;
import animation.common.CanvasRepaintListener;
import animation.common.Interactable;
import animation.common.MainCanvas;
import animation.draw_pic.sprites.Background;
import animation.draw_pic.sprites.Picture;
...
public class MainWindow extends JFrame implements CanvasRepaintListener, Thread.UncaughtExceptionHandler {
    ...
    private static final int MAX_COUNT_SPRITES = 16;
